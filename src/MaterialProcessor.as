 ...
 */
public class MaterialProcessor extends EventDispatcher{
	...
	public function setupMaterials(objects:Vector.<Object3D>):void {
		...
		var event:MaterialProcessorEvent = new MaterialProcessorEvent(MaterialProcessorEvent.ON_TEXTURES_SETUP_FINISHED);
		dispatchEvent(event);
	}
